...
public enum AircraftIcon {
    ...
    /**
     * Returns the proper icon for a given aircraft's data
     *
     * @param typeDesignator         the type designator
     * @param typeDescription        the type description
     * @param category               the category
     * @param wakeTurbulenceCategory the wake turbulence category
     * @return the icon for the aircraft state
     */
    ...
    /**
     * Returns true if the aircraft state can rotate, false otherwise
     *
     * @return true if the aircraft state can rotate, false otherwise
     */
    ...
    /**
     * Returns the name of the SVGPath for the aircraft state
     *
     * @return the name of the SVGPath for the aircraft state
     */
