...
class AdsbDemodulatorTest {
    ...
    void adsbDemodulatorNextMessageWorksOnGivenSamples() throws IOException {
        ...
        try (var s = new FileInputStream("/Users/matteo/Desktop/Javions/resources/samples_20230304_1442.bin")) {
            var demodulator = new AdsbDemodulator(s);
            int count = 0;
            while (expectedIt.hasNext()) {
                ...
                System.out.println("ex:" + expected.bytes());
                System.out.println("ac:" + actual.bytes().toString());
                //assertEquals(expected.timeStampNs(), actual.timeStampNs());
                System.out.println("exTs:" + expected.timeStampNs());
                System.out.println("acTs:" + actual.timeStampNs());
            }
            assertNull(demodulator.nextMessage());
        }
    }
